...
export function VideoInputForm(props: VideoInputFormProps){
    ...
    return(
      ...
      <label 
       ...
       gap-2 items-center justify-center text-muted-foreground
       hover:bg-primary/5 relative object-cover"
       htmlFor="video"
      > 
        {previewUrl ? (
      ...
      <div className="space-y-2">
         <Label htmlFor="transcription_prompt">Promtpt de transcrição</Label>
         <Textarea 
